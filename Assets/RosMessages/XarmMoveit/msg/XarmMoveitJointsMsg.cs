...
{
    [Serializable]
    public class XarmMoveitJointsMsg : Message
    {
        public const string k_RosMessageName = "xarm_moveit/XarmMoveitJoints";
        ...
        public XarmMoveitJointsMsg(double[] joints, Geometry.PoseMsg pick_pose, Geometry.PoseMsg place_pose)
        {
            this.joints = joints;
        ...
        public static XarmMoveitJointsMsg Deserialize(MessageDeserializer deserializer) => new XarmMoveitJointsMsg(deserializer);

        private XarmMoveitJointsMsg(MessageDeserializer deserializer)
        {
