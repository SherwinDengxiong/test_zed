...
namespace RosMessageTypes.XarmMoveit
{
    ...
    {
        public const string k_RosMessageName = "xarm_moveit/MoverService";
        public override string RosMessageName => k_RosMessageName;

        public XarmMoveitJointsMsg joints_input;
        public Geometry.PoseMsg pick_pose;
        public Geometry.PoseMsg place_pose;

        public MoverServiceRequest()
        {
            this.joints_input = new XarmMoveitJointsMsg();
            this.pick_pose = new Geometry.PoseMsg();
            this.place_pose = new Geometry.PoseMsg();
        }

        public MoverServiceRequest(XarmMoveitJointsMsg joints_input, Geometry.PoseMsg pick_pose, Geometry.PoseMsg place_pose)
        {
        ...
        {
            this.joints_input = XarmMoveitJointsMsg.Deserialize(deserializer);
